...
if __name__ == '__main__':
    ...
    for step in tqdm(
        ...
        if step % 5 == 0 and step > 50:
            ...
            rec_auc_all, ap, rec_auc_abn, far_all, far_abn = test(test_loader, model, args, viz,viz_name, device,best_AUC,plot_curve=True, step=step)
