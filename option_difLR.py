...
parser.add_argument('--pretrained-model', default=None, help='path for pretrained model')
...
parser.add_argument('--emb_folder', type=str, default='sent_emb_n', help='(uca_sent_emb_n \sent_emb_n) folder for text embeddings, used to differenciate different swinbert pretrained models')
...
parser.add_argument('--gama', type=float, default=0.1, help='weight for MPL loss') #0.1/1